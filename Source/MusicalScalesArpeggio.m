...
+ (NSInteger const * const)halfstepsArray { static const NSInteger halfsteps[] = {0,4,6,8}; return halfsteps; }
...
+ (NSString const *)category { static NSString const *categ = @"Arpeggios"; return categ; }
+ (NSInteger const * const)halfstepsArray { static const NSInteger halfsteps[] = {0,3,6,10}; return halfsteps; }
+ (NSUInteger const)halfstepsArrayCount { return 4; }
+ (NSUInteger const)octavesCovered { return 1; }
@end
...
+ (NSString const *)category { static NSString const *categ = @"Arpeggios"; return categ; }
+ (NSInteger const * const)halfstepsArray { static const NSInteger halfsteps[] = {0,4,6,11,14,17,20}; return halfsteps; }
